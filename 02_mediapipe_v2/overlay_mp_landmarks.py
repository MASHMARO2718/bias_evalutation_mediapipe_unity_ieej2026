...
入力:
  01_input_videos/CapturedFrames_{X}_{Y}_{Z}/video.mp4
  02_mediapipe_v2/mediapipe_processed_csv/Y={y}/CapturedFrames_{X}_{Y}_{Z}.csv

出力:
  02_mediapipe_v2/overlay_videos/Y={y}/CapturedFrames_{X}_{Y}_{Z}_mp_overlay.mp4
...
def main():
    ...
    parser.add_argument(
        "--input_dir",
        default=str(root / "01_input_videos"),
