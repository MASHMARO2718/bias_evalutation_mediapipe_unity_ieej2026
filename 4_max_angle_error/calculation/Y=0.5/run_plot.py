...
9_legacy_v1/mediapipe_processed の CSV を参照（重複コピー不要）
"""
import os
import glob
import sys
...
mp_dir = project_root / "9_legacy_v1/mediapipe_processed" / y_range

print(f"作業ディレクトリ: {current_dir}")
os.chdir(current_dir)

# 9_legacy_v1/mediapipe_processed から CSV を参照
