...
1_input/CapturedFrames_{X}_{Y}_{Z}/video.mp4 を読み込み、
フレームごとに MediaPipe Pose を適用して
2_pose/mediapipe_processed_csv/Y={y}/CapturedFrames_{X}_{Y}_{Z}.csv を出力する。
...
使用方法:
    ...
    python mediapipe_video_processor.py --input_dir ../1_input --max_videos 5
...
def main():
    ...
    parser.add_argument('--input_dir', default=str(script_dir.parent / '1_input'),
