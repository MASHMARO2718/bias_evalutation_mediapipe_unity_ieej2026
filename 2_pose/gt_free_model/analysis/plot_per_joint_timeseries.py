...
出力: 2_pose/gt_free_model/per_joint/val_<JOINT>.png
"""
...
CALIB_GT = BASE.parent / "1_input/CapturedFrames_3.0_1.0_0.0/gt_joints.csv"
VAL_MP = BASE / "mediapipe_processed_csv_additional/Y=0.5/CapturedFrames_3.2_1.1_0.4.csv"
VAL_GT = (BASE.parent
          / "1_input/aditional__test_data/CapturedFrames_3.2_1.1_0.4/gt_joints.csv")
