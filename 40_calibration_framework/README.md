...
| ファイル | 場所 | 用途 |
|---|---|---|
| `coordinate_angle_mae.csv` | `../30_joint_angle_mae/joint_angle_mae_csv/Y=*/` | メイン入力（全4層必須） |
| `frame_camera_summary.csv` | `../32_direction_detection/output/processed_data/` | 方向角評価（任意） |
