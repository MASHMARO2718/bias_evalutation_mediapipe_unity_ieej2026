...
実行する場合はリポジトリルートからではなく **`40_calibration_framework/` ディレクトリ内**で行ってください。
...
**入力:**
- `32_direction_detection/output/processed_data/detailed_results.csv`
- `40_calibration_framework/src/config.py`（パス定義）
