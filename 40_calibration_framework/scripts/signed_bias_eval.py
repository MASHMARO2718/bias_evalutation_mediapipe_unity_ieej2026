...
出力
----
  40_calibration_framework/outputs/results/signed_bias_results.csv
  40_calibration_framework/outputs/results/lambda_sensitivity.csv
"""
...
HERE = Path(__file__).resolve().parent.parent  # 40_calibration_framework/
