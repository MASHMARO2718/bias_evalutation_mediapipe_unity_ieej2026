...
出力: 20_pose_correction/mediapipe_world_csv/<folder>.csv
...
DEFAULT_VIDEOS = [
    BASE.parent / "10_input_videos/CapturedFrames_3.0_1.0_0.0/video.mp4",
    BASE.parent / "10_input_videos/aditional__test_data/CapturedFrames_3.2_1.1_0.4/video.mp4",
]
