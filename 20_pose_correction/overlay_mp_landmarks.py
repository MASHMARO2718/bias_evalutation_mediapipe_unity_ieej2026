...
入力:
  10_input_videos/CapturedFrames_{X}_{Y}_{Z}/video.mp4
  20_pose_correction/mediapipe_processed_csv/Y={y}/CapturedFrames_{X}_{Y}_{Z}.csv

出力:
  20_pose_correction/overlay_videos/Y={y}/CapturedFrames_{X}_{Y}_{Z}_mp_overlay.mp4
...
def main():
    ...
    parser.add_argument(
        "--input_dir",
        default=str(root / "10_input_videos"),
