...
def migrate_02_mp(dry: bool) -> int:
    mp_root = REPO / "9_legacy_v1/mediapipe_processed"
    moved = 0
...
def migrate_03_mae(dry: bool) -> int:
    mae_root = REPO / "3_joint_angle_mae"
    written = 0
...
def main() -> None:
    ...
    print("=== 9_legacy_v1/mediapipe_processed ===")
    n = migrate_02_mp(args.dry_run)
    print(f"moved files: {n}")

    print("=== 3_joint_angle_mae (coordinate_angle_mae.csv) ===")
