...
- `9_legacy_v1/mediapipe_processed/mediapipe_processed_csv/Y={y}/CapturedFrames_{x}_{y}_{z}.csv`
...
```python
# 7_correction/scripts/plot_angle_timeseries.py を実行し
