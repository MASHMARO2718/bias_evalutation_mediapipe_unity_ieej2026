...
**作成**: 2026-07-19
**実装**: `02_mediapipe_v2/run_world_landmark_model.py`
（world 抽出: `extract_world_landmarks.py` → `mediapipe_world_csv/`）
**出力**: `02_mediapipe_v2/world_landmark_model/`
...
| パス | 内容 |
|---|---|
| `02_mediapipe_v2/extract_world_landmarks.py` | world landmarks 抽出（2 動画再処理） |
| `02_mediapipe_v2/mediapipe_world_csv/` | 抽出済み world CSV |
| `02_mediapipe_v2/run_world_landmark_model.py` | 較正→検証の通し実行 |
| `02_mediapipe_v2/world_landmark_model/SUMMARY.md` | 数値サマリ |
...
再実行: `cd 02_mediapipe_v2 && python extract_world_landmarks.py &&
