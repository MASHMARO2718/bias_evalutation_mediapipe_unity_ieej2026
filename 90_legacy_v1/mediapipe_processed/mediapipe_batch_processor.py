...
使用方法:
    python mediapipe_batch_processor.py --input_dir JPEG_OUTPUT --output_base_dir 90_legacy_v1/mediapipe_processed
...
def main():
    ...
    default_out = Path(__file__).parent  # 90_legacy_v1/mediapipe_processed 自体をデフォルト
    parser.add_argument('--output_base_dir', default=str(default_out), help='Y別出力のベース。デフォルト: 90_legacy_v1/mediapipe_processed（Y=0.5, Y=1.0, Y=1.5, Y=2.0 配下）')
