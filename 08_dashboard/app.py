...
プロジェクトルート直下の 09_dashboard/ に配置。
06_direction_detection の output を参照。
"""
...
# パス設定: プロジェクトルートと 06_direction_detection
project_root = Path(__file__).parent.parent
sys.path.insert(0, str(project_root))
dir06 = project_root / "06_direction_detection"
sys.path.insert(0, str(dir06))
