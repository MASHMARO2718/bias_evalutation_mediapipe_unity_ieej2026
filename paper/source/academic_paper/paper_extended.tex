...
%    ../picture/Unity実験環境.png
%    ../picture/frame_0018.jpg
% ============================================================
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.30\textwidth]{../picture/camera_layout.png}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.44\textwidth]{../picture/Unity実験環境.png}
  \vspace{0.3em}
  \includegraphics[width=0.44\textwidth]{../picture/frame_0018.jpg}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.48\linewidth]{../picture/角度の概念図.png}
...
\begin{figure}[!t]
  ...
  \begin{subfigure}[b]{0.48\linewidth}
    \includegraphics[width=\linewidth]%
      {../graphs/heatmap_L_Elbow_Y0_5.jpg}
    \caption{Left elbow $\Delta\theta$ (Y=0.5)}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.48\linewidth}
    \includegraphics[width=\linewidth]%
      {../graphs/heatmap_R_Elbow_Y0_5.jpg}
...
\begin{figure}[!t]
  ...
  \includegraphics[width=0.75\linewidth]%
    {../graphs/heatmap_LEFT_HIP_psi_Y0_5.jpg}
...
\begin{figure*}[t]
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../graphs/heatmap_theta.png}
    \caption{$\Delta\theta$ (XY plane)}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{../graphs/heatmap_psi.png}
