...
def main() -> None:
    print("=== 1. Table 1 (Joint Angle MAE) - primary: 3_joint_angle_mae ===")
    mae_layers = [
    ...
    print("\n=== 2. Direction angles - joint_summary.csv (5_direction) ===")
    ...
    print("\n=== 4. Data source memo ===")
    print("  5_direction: GT=synced_joint_positions, MP=9_legacy_v1/mediapipe_processed")
    print("  3_joint_angle_mae: per-camera MAE CSV（run_cal_mae 等で生成）→ create_statistics_table で集計可")
    print("  Y-flip: 方向角のみ 5_direction/scripts/coordinate_transform.py")
