...
90_legacy_v1/mediapipe_processed の CSV を参照（重複コピー不要）
"""
import os
import glob
import sys
...
current_dir = Path(__file__).parent  # calculation/Y=<layer>/
y_range = current_dir.name
project_root = current_dir.parent.parent.parent
mp_dir = project_root / "90_legacy_v1/mediapipe_processed" / y_range

print(f"作業ディレクトリ: {current_dir}")
os.chdir(current_dir)

# 90_legacy_v1/mediapipe_processed から CSV を参照
